...
2. **Configuração da VM Orquestradora (`VM10_SETUP.md`):** Documento detalhando os comandos de terminal para preparação do sistema operacional Ubuntu, configuração estática de rede via Netplan, instalação e configuração do Docker e **OpenStack Client**.
